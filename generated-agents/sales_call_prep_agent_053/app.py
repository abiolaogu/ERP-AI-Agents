...
Auto-generated from catalog definition: sales_call_prep_agent_053
"""
...
# Configuration
class Config:
    APP_NAME = "sales-call-prep-agent-053"
    VERSION = "1.0.0"
    PORT = 8253
...
# Service
class SalesCallPrepAgentService:
    """Main agent service"""
...
# Application
app = FastAPI(
    title="Sales Call Prep Agent",
    description="Briefs reps before each call with research",
    version=config.VERSION
)

service = SalesCallPrepAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
