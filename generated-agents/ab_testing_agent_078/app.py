...
Auto-generated from catalog definition: ab_testing_agent_078
"""
...
app = FastAPI(
    ...
    description="Suggests experiments and interprets results",
    version=config.VERSION
)

service = TestingAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
