...
Auto-generated from catalog definition: expansion_feasibility_agent_024
"""
...
# Configuration
class Config:
    APP_NAME = "expansion-feasibility-agent-024"
    VERSION = "1.0.0"
    PORT = 8224
...
# Service
class ExpansionFeasibilityAgentService:
    """Main agent service"""
...
# Application
app = FastAPI(
    title="Expansion Feasibility Agent",
    description="Evaluates new city/country expansion",
    version=config.VERSION
)

service = ExpansionFeasibilityAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
