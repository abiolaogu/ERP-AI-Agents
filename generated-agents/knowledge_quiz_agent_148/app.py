...
Trains support staff with mini-quizzes

Auto-generated from catalog definition: knowledge_quiz_agent_148
"""
...
# Configuration
class Config:
    APP_NAME = "knowledge-quiz-agent-148"
    VERSION = "1.0.0"
    PORT = 8348
...
# Service
class KnowledgeQuizAgentService:
    """Main agent service"""
...
# Application
app = FastAPI(
    title="Knowledge Quiz Agent",
    description="Trains support staff with mini-quizzes",
    version=config.VERSION
)

service = KnowledgeQuizAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
