...
Auto-generated from catalog definition: proactive_outreach_agent_116
"""
...
# Configuration
class Config:
    APP_NAME = "proactive-outreach-agent-116"
    VERSION = "1.0.0"
    PORT = 8316
...
# Service
class ProactiveOutreachAgentService:
    """Main agent service"""
...
app = FastAPI(
    ...
    description="Messages users when errors are detected",
    version=config.VERSION
)

service = ProactiveOutreachAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
