"""
Press Release Agent
Writes press releases from bullet points

Auto-generated from catalog definition: press_release_agent_082
"""
...
# Configuration
class Config:
    APP_NAME = "press-release-agent-082"
    VERSION = "1.0.0"
    PORT = 8282
...
# Service
class PressReleaseAgentService:
    """Main agent service"""
...
app = FastAPI(
    ...
    description="Writes press releases from bullet points",
    version=config.VERSION
)

service = PressReleaseAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
