...
Auto-generated from catalog definition: ideal_customer_profile_agent_065
"""
...
# Configuration
class Config:
    APP_NAME = "ideal-customer-profile-agent-065"
    VERSION = "1.0.0"
    PORT = 8265
...
# Service
class IdealCustomerProfileAgentService:
    """Main agent service"""
...
# Application
app = FastAPI(
    title="Ideal Customer Profile Agent",
    description="Refines ICP based on closed-won data",
    version=config.VERSION
)

service = IdealCustomerProfileAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
