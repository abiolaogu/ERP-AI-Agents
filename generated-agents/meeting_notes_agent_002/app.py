...
Auto-generated from catalog definition: meeting_notes_agent_002
"""
...
# Configuration
class Config:
    APP_NAME = "meeting-notes-agent-002"
    VERSION = "1.0.0"
    PORT = 8202
...
# Service
class MeetingNotesAgentService:
    """Main agent service"""
...
app = FastAPI(
    ...
    description="Records, cleans up, and summarizes meetings",
    version=config.VERSION
)

service = MeetingNotesAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
