"""
Product Tour Agent
Gives interactive walkthroughs of features

Auto-generated from catalog definition: product_tour_agent_104
"""
...
# Configuration
class Config:
    APP_NAME = "product-tour-agent-104"
    VERSION = "1.0.0"
    PORT = 8304
...
# Application
app = FastAPI(
    title="Product Tour Agent",
    description="Gives interactive walkthroughs of features",
    version=config.VERSION
)

service = ProductTourAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
