"""
Delegation Agent
Suggests which tasks to automate or delegate

Auto-generated from catalog definition: delegation_agent_046
"""
...
app = FastAPI(
    ...
    description="Suggests which tasks to automate or delegate",
    version=config.VERSION
)

service = DelegationAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
