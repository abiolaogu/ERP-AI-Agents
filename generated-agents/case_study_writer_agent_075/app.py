...
Auto-generated from catalog definition: case_study_writer_agent_075
"""
...
# Configuration
class Config:
    APP_NAME = "case-study-writer-agent-075"
    VERSION = "1.0.0"
    PORT = 8275
...
# Service
class CaseStudyWriterAgentService:
    """Main agent service"""
...
app = FastAPI(
    ...
    description="Turns project notes into case studies",
    version=config.VERSION
)

service = CaseStudyWriterAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
