...
Auto-generated from catalog definition: selfservice_portal_agent_126
"""
...
# Configuration
class Config:
    APP_NAME = "selfservice-portal-agent-126"
    VERSION = "1.0.0"
    PORT = 8326
...
# Application
app = FastAPI(
    title="Self-Service Portal Agent",
    description="Guides users to self-serve options",
    version=config.VERSION
)

service = PortalAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
