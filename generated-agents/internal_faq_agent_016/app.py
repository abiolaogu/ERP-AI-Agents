...
Auto-generated from catalog definition: internal_faq_agent_016
"""
...
# Configuration
class Config:
    APP_NAME = "internal-faq-agent-016"
    VERSION = "1.0.0"
    PORT = 8216
...
# Application
app = FastAPI(
    title="Internal FAQ Agent",
    description="Answers employee questions from internal docs",
    version=config.VERSION
)

service = InternalFaqAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
