...
Auto-generated from catalog definition: feedback_categorization_agent_127
"""
...
# Configuration
class Config:
    APP_NAME = "feedback-categorization-agent-127"
    VERSION = "1.0.0"
    PORT = 8327
...
# Service
class FeedbackCategorizationAgentService:
    """Main agent service"""
...
# Application
app = FastAPI(
    title="Feedback Categorization Agent",
    description="Tags feedback into themes",
    version=config.VERSION
)

service = FeedbackCategorizationAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
