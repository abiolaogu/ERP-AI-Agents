...
Auto-generated from catalog definition: onboarding_wizard_agent_103
"""
...
# Configuration
class Config:
    APP_NAME = "onboarding-wizard-agent-103"
    VERSION = "1.0.0"
    PORT = 8303
...
# Service
class OnboardingWizardAgentService:
    """Main agent service"""
...
# Application
app = FastAPI(
    title="Onboarding Wizard Agent",
    description="Guides new users through setup",
    version=config.VERSION
)

service = OnboardingWizardAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
