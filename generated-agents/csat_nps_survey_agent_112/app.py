...
Auto-generated from catalog definition: csat_nps_survey_agent_112
"""
...
# Configuration
class Config:
    APP_NAME = "csat-nps-survey-agent-112"
    VERSION = "1.0.0"
    PORT = 8312
...
# Application
app = FastAPI(
    title="CSAT/NPS Survey Agent",
    description="Manages surveys and analyzes results",
    version=config.VERSION
)

service = SurveyAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
