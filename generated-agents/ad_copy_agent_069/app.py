"""
Ad Copy Agent
Generates and tests ad versions for Meta/Google/TikTok

Auto-generated from catalog definition: ad_copy_agent_069
"""
...
app = FastAPI(
    title="Ad Copy Agent",
    description="Generates and tests ad versions for Meta/Google/TikTok",
    version=config.VERSION
)

service = AdCopyAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
