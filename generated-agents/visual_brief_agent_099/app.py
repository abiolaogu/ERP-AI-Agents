...
Auto-generated from catalog definition: visual_brief_agent_099
"""
...
# Configuration
class Config:
    APP_NAME = "visual-brief-agent-099"
    VERSION = "1.0.0"
    PORT = 8299
...
# Application
app = FastAPI(
    title="Visual Brief Agent",
    description="Creates briefs for designers from text prompts",
    version=config.VERSION
)

service = VisualBriefAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
