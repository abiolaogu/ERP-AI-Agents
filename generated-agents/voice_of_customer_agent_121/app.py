...
Auto-generated from catalog definition: voice_of_customer_agent_121
"""
...
# Configuration
class Config:
    APP_NAME = "voice-of-customer-agent-121"
    VERSION = "1.0.0"
    PORT = 8321
...
app = FastAPI(
    ...
    description="Summarizes themes from tickets and reviews",
    version=config.VERSION
)

service = AgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
