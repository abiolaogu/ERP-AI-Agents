"""
Procurement Agent
Drafts purchase orders and compares quotes

Auto-generated from catalog definition: procurement_agent_030
"""
...
# Configuration
class Config:
    APP_NAME = "procurement-agent-030"
    VERSION = "1.0.0"
    PORT = 8230
...
app = FastAPI(
    ...
    description="Drafts purchase orders and compares quotes",
    version=config.VERSION
)

service = ProcurementAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
