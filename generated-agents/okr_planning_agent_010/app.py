...
Auto-generated from catalog definition: okr_planning_agent_010
"""
...
# Configuration
class Config:
    APP_NAME = "okr-planning-agent-010"
    VERSION = "1.0.0"
    PORT = 8210
...
# Application
app = FastAPI(
    title="OKR Planning Agent",
    description="Helps define objectives and key results per quarter",
    version=config.VERSION
)

service = OkrPlanningAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
