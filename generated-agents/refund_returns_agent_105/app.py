...
Auto-generated from catalog definition: refund_returns_agent_105
"""
...
# Configuration
class Config:
    APP_NAME = "refund-returns-agent-105"
    VERSION = "1.0.0"
    PORT = 8305
...
# Service
class RefundAndReturnsAgentService:
    """Main agent service"""
...
# Application
app = FastAPI(
    title="Refund & Returns Agent",
    description="Handles simple refund/return workflows",
    version=config.VERSION
)

service = RefundAndReturnsAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
