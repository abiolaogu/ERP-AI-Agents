"""
Brand Voice Agent
Enforces tone across content

Auto-generated from catalog definition: brand_voice_agent_071
"""
...
# Configuration
class Config:
    APP_NAME = "brand-voice-agent-071"
    VERSION = "1.0.0"
    PORT = 8271
...
app = FastAPI(
    ...
    description="Enforces tone across content",
    version=config.VERSION
)

service = BrandVoiceAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
