...
Answers common FAQs across channels

Auto-generated from catalog definition: tier1_support_agent_101
"""
...
# Configuration
class Config:
    APP_NAME = "tier1-support-agent-101"
    VERSION = "1.0.0"
    PORT = 8301
...
app = FastAPI(
    ...
    description="Answers common FAQs across channels",
    version=config.VERSION
)

service = SupportAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
