...
Auto-generated from catalog definition: objection_handling_agent_057
"""
...
# Configuration
class Config:
    APP_NAME = "objection-handling-agent-057"
    VERSION = "1.0.0"
    PORT = 8257
...
# Service
class ObjectionHandlingAgentService:
    """Main agent service"""
...
app = FastAPI(
    ...
    description="Recommends responses to common objections",
    version=config.VERSION
)

service = ObjectionHandlingAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
