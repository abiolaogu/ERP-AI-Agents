...
Auto-generated from catalog definition: event_followup_agent_089
"""
...
# Configuration
class Config:
    APP_NAME = "event-followup-agent-089"
    VERSION = "1.0.0"
    PORT = 8289
...
app = FastAPI(
    ...
    description="Sends tailored follow-up messages post-event",
    version=config.VERSION
)

service = EventAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
