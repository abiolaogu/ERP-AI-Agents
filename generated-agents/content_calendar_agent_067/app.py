...
Auto-generated from catalog definition: content_calendar_agent_067
"""
...
# Configuration
class Config:
    APP_NAME = "content-calendar-agent-067"
    VERSION = "1.0.0"
    PORT = 8267
...
# Service
class ContentCalendarAgentService:
    """Main agent service"""
...
app = FastAPI(
    ...
    description="Plans monthly content topics and dates",
    version=config.VERSION
)

service = ContentCalendarAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
