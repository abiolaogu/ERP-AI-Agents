...
Helps pause, cancel, or upgrade plans

Auto-generated from catalog definition: subscription_management_agent_137
"""
...
# Configuration
class Config:
    APP_NAME = "subscription-management-agent-137"
    VERSION = "1.0.0"
    PORT = 8337
...
# Service
class SubscriptionManagementAgentService:
    """Main agent service"""
...
app = FastAPI(
    ...
    description="Helps pause, cancel, or upgrade plans",
    version=config.VERSION
)

service = SubscriptionManagementAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
