...
Auto-generated from catalog definition: sop_builder_agent_004
"""
...
# Configuration
class Config:
    APP_NAME = "sop-builder-agent-004"
    VERSION = "1.0.0"
    PORT = 8204
...
# Application
app = FastAPI(
    title="SOP Builder Agent",
    description="Turns repeated workflows into standard operating procedures",
    version=config.VERSION
)

service = SopBuilderAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
