...
Configures personalized first steps for users

Auto-generated from catalog definition: getting_started_agent_149
"""
...
# Configuration
class Config:
    APP_NAME = "getting-started-agent-149"
    VERSION = "1.0.0"
    PORT = 8349
...
# Service
class GettingStartedAgentService:
    """Main agent service"""
...
app = FastAPI(
    ...
    description="Configures personalized first steps for users",
    version=config.VERSION
)

service = GettingStartedAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
