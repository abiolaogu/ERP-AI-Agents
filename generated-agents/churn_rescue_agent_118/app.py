"""
Churn Rescue Agent
Intervenes when customers show leaving signals

Auto-generated from catalog definition: churn_rescue_agent_118
"""
...
# Configuration
class Config:
    APP_NAME = "churn-rescue-agent-118"
    VERSION = "1.0.0"
    PORT = 8318
...
# Application
app = FastAPI(
    title="Churn Rescue Agent",
    description="Intervenes when customers show leaving signals",
    version=config.VERSION
)

service = ChurnRescueAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
