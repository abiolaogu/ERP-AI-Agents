...
Auto-generated from catalog definition: abm_agent_096
"""
...
# Application
app = FastAPI(
    title="ABM (Account-Based Marketing) Agent",
    description="Plans campaigns for key accounts",
    version=config.VERSION
)

service = AbmAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
...
async def root():
    return {
        "agent_id": config.APP_NAME,
        "name": "ABM (Account-Based Marketing) Agent",
        "version": config.VERSION,
        "status": "operational",
