...
Auto-generated from catalog definition: document_redline_agent_029
"""
...
# Configuration
class Config:
    APP_NAME = "document-redline-agent-029"
    VERSION = "1.0.0"
    PORT = 8229
...
# Service
class DocumentRedlineAgentService:
    """Main agent service"""
...
# Application
app = FastAPI(
    title="Document Redline Agent",
    description="Highlights risks or issues in contracts and memos",
    version=config.VERSION
)

service = DocumentRedlineAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
