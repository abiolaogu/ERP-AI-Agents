...
Auto-generated from catalog definition: appointment_scheduling_agent_125
"""
...
# Configuration
class Config:
    APP_NAME = "appointment-scheduling-agent-125"
    VERSION = "1.0.0"
    PORT = 8325
...
# Service
class AppointmentSchedulingAgentService:
    """Main agent service"""
...
service = AppointmentSchedulingAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
