...
Reviews call transcripts and gives feedback

Auto-generated from catalog definition: sales_coaching_agent_061
"""
...
# Configuration
class Config:
    APP_NAME = "sales-coaching-agent-061"
    VERSION = "1.0.0"
    PORT = 8261
...
# Service
class SalesCoachingAgentService:
    """Main agent service"""
...
app = FastAPI(
    ...
    description="Reviews call transcripts and gives feedback",
    version=config.VERSION
)

service = SalesCoachingAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
