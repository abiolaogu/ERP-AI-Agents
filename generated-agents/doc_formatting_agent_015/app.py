...
Auto-generated from catalog definition: doc_formatting_agent_015
"""
...
# Configuration
class Config:
    APP_NAME = "doc-formatting-agent-015"
    VERSION = "1.0.0"
    PORT = 8215
...
# Service
class DocFormattingAgentService:
    """Main agent service"""
...
# Application
app = FastAPI(
    title="Doc Formatting Agent",
    description="Makes documents consistent with brand style",
    version=config.VERSION
)

service = DocFormattingAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
