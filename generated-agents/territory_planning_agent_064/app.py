...
Auto-generated from catalog definition: territory_planning_agent_064
"""
...
# Configuration
class Config:
    APP_NAME = "territory-planning-agent-064"
    VERSION = "1.0.0"
    PORT = 8264
...
# Service
class TerritoryPlanningAgentService:
    """Main agent service"""
...
# Application
app = FastAPI(
    title="Territory Planning Agent",
    description="Helps allocate reps by geography/segment",
    version=config.VERSION
)

service = TerritoryPlanningAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
