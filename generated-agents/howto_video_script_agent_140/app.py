...
Auto-generated from catalog definition: howto_video_script_agent_140
"""
...
# Configuration
class Config:
    APP_NAME = "howto-video-script-agent-140"
    VERSION = "1.0.0"
    PORT = 8340
...
# Service
class HowToUseVideoScriptAgentService:
    """Main agent service"""
...
# Application
app = FastAPI(
    title="How To Use Video Script Agent",
    description="Scripts short support videos",
    version=config.VERSION
)

service = HowToUseVideoScriptAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
...
async def root():
    return {
        "agent_id": config.APP_NAME,
        "name": "How To Use Video Script Agent",
        "version": config.VERSION,
        "status": "operational",
