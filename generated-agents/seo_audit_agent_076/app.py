...
Auto-generated from catalog definition: seo_audit_agent_076
"""
...
app = FastAPI(
    ...
    description="Suggests fixes for on-page SEO",
    version=config.VERSION
)

service = SeoAuditAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
