"""
Order Change Agent
Helps modify orders when allowed

Auto-generated from catalog definition: order_change_agent_131
"""
...
# Configuration
class Config:
    APP_NAME = "order-change-agent-131"
    VERSION = "1.0.0"
    PORT = 8331
...
# Application
app = FastAPI(
    title="Order Change Agent",
    description="Helps modify orders when allowed",
    version=config.VERSION
)

service = OrderChangeAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
