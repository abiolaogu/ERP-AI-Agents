"""
Help Center IA Agent
Designs structure of help center categories

Auto-generated from catalog definition: help_center_ia_agent_143
"""
...
# Configuration
class Config:
    APP_NAME = "help-center-ia-agent-143"
    VERSION = "1.0.0"
    PORT = 8343
...
# Service
class HelpCenterIaAgentService:
    """Main agent service"""
...
# Application
app = FastAPI(
    title="Help Center IA Agent",
    description="Designs structure of help center categories",
    version=config.VERSION
)

service = HelpCenterIaAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
