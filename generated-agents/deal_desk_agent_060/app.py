"""
Deal Desk Agent
Checks discounts and terms against policies

Auto-generated from catalog definition: deal_desk_agent_060
"""
...
app = FastAPI(
    ...
    description="Checks discounts and terms against policies",
    version=config.VERSION
)

service = DealDeskAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
