...
Auto-generated from catalog definition: escalation_router_agent_108
"""
...
# Configuration
class Config:
    APP_NAME = "escalation-router-agent-108"
    VERSION = "1.0.0"
    PORT = 8308
...
# Service
class EscalationRouterAgentService:
    """Main agent service"""
...
# Application
app = FastAPI(
    title="Escalation Router Agent",
    description="Decides when to escalate to humans",
    version=config.VERSION
)

service = EscalationRouterAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
