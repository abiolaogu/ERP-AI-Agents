"""
FAQ Gap Agent
Finds recurring questions without clear answers

Auto-generated from catalog definition: faq_gap_agent_115
"""
...
app = FastAPI(
    title="FAQ Gap Agent",
    description="Finds recurring questions without clear answers",
    version=config.VERSION
)

service = FaqGapAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
