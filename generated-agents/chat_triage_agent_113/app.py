"""
Chat Triage Agent
Routes queries to right department

Auto-generated from catalog definition: chat_triage_agent_113
"""
...
# Configuration
class Config:
    APP_NAME = "chat-triage-agent-113"
    VERSION = "1.0.0"
    PORT = 8313
...
# Application
app = FastAPI(
    title="Chat Triage Agent",
    description="Routes queries to right department",
    version=config.VERSION
)

service = ChatTriageAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
