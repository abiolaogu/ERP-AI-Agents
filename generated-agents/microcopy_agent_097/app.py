...
Auto-generated from catalog definition: microcopy_agent_097
"""
...
# Application
app = FastAPI(
    title="Microcopy Agent",
    description="Writes CTAs, tooltips, button text",
    version=config.VERSION
)

service = MicrocopyAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
