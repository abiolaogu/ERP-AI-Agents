...
Compares suppliers across price, quality, and terms

Auto-generated from catalog definition: vendor_comparison_agent_007
"""
...
# Configuration
class Config:
    APP_NAME = "vendor-comparison-agent-007"
    VERSION = "1.0.0"
    PORT = 8207
...
# Service
class VendorComparisonAgentService:
    """Main agent service"""
...
app = FastAPI(
    ...
    description="Compares suppliers across price, quality, and terms",
    version=config.VERSION
)

service = VendorComparisonAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
