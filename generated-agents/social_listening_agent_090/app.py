...
Summarizes brand mentions and sentiment

Auto-generated from catalog definition: social_listening_agent_090
"""
...
# Configuration
class Config:
    APP_NAME = "social-listening-agent-090"
    VERSION = "1.0.0"
    PORT = 8290
...
# Service
class SocialListeningAgentService:
    """Main agent service"""
...
app = FastAPI(
    ...
    description="Summarizes brand mentions and sentiment",
    version=config.VERSION
)

service = SocialListeningAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
