...
Drafts tiers, perks, and rules

Auto-generated from catalog definition: loyalty_program_agent_087
"""
...
# Configuration
class Config:
    APP_NAME = "loyalty-program-agent-087"
    VERSION = "1.0.0"
    PORT = 8287
...
# Service
class LoyaltyProgramAgentService:
    """Main agent service"""
...
app = FastAPI(
    ...
    description="Drafts tiers, perks, and rules",
    version=config.VERSION
)

service = LoyaltyProgramAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
