...
Digs into LinkedIn, websites, and news for intel

Auto-generated from catalog definition: account_research_agent_058
"""
...
# Configuration
class Config:
    APP_NAME = "account-research-agent-058"
    VERSION = "1.0.0"
    PORT = 8258
...
# Service
class AccountResearchAgentService:
    """Main agent service"""
...
app = FastAPI(
    ...
    description="Digs into LinkedIn, websites, and news for intel",
    version=config.VERSION
)

service = AccountResearchAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
