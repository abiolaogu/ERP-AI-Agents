...
Auto-generated from catalog definition: board_pack_agent_023
"""
...
# Application
app = FastAPI(
    title="Board Pack Agent",
    description="Assembles slides and summaries for board meetings",
    version=config.VERSION
)

service = BoardPackAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
