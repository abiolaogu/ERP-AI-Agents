...
Auto-generated from catalog definition: campaign_idea_agent_100
"""
...
# Configuration
class Config:
    APP_NAME = "campaign-idea-agent-100"
    VERSION = "1.0.0"
    PORT = 8300
...
# Service
class CampaignIdeaAgentService:
    """Main agent service"""
...
# Application
app = FastAPI(
    title="Campaign Idea Agent",
    description="Generates creative campaign concepts",
    version=config.VERSION
)

service = CampaignIdeaAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
