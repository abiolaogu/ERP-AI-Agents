...
Auto-generated from catalog definition: troubleshooting_guide_agent_102
"""
...
# Configuration
class Config:
    APP_NAME = "troubleshooting-guide-agent-102"
    VERSION = "1.0.0"
    PORT = 8302
...
# Service
class TroubleshootingGuideAgentService:
    """Main agent service"""
...
# Application
app = FastAPI(
    title="Troubleshooting Guide Agent",
    description="Walks customers through step-by-step checks",
    version=config.VERSION
)

service = TroubleshootingGuideAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
