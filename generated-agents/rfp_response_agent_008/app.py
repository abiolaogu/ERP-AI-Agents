"""
RFP Response Agent
Helps respond to tenders and RFPs using past proposals

Auto-generated from catalog definition: rfp_response_agent_008
"""
...
# Configuration
class Config:
    APP_NAME = "rfp-response-agent-008"
    VERSION = "1.0.0"
    PORT = 8208
...
app = FastAPI(
    ...
    description="Helps respond to tenders and RFPs using past proposals",
    version=config.VERSION
)

service = RfpResponseAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
