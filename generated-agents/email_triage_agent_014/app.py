...
Auto-generated from catalog definition: email_triage_agent_014
"""
...
# Configuration
class Config:
    APP_NAME = "email-triage-agent-014"
    VERSION = "1.0.0"
    PORT = 8214
...
app = FastAPI(
    ...
    description="Classifies and prioritizes incoming emails",
    version=config.VERSION
)

service = EmailTriageAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
