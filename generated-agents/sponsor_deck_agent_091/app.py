"""
Sponsor Deck Agent
Creates sponsorship proposals for events/podcasts

Auto-generated from catalog definition: sponsor_deck_agent_091
"""
...
# Configuration
class Config:
    APP_NAME = "sponsor-deck-agent-091"
    VERSION = "1.0.0"
    PORT = 8291
...
# Application
app = FastAPI(
    title="Sponsor Deck Agent",
    description="Creates sponsorship proposals for events/podcasts",
    version=config.VERSION
)

service = SponsorDeckAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
