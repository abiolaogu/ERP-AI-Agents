...
Auto-generated from catalog definition: governance_agent_043
"""
...
app = FastAPI(
    ...
    description="Suggests governance structures and roles",
    version=config.VERSION
)

service = GovernanceAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
