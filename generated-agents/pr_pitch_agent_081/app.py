"""
PR Pitch Agent
Drafts story angles and journalist emails

Auto-generated from catalog definition: pr_pitch_agent_081
"""
...
# Application
app = FastAPI(
    title="PR Pitch Agent",
    description="Drafts story angles and journalist emails",
    version=config.VERSION
)

service = PrPitchAgentService(config.CLAUDE_API_KEY, config.CLAUDE_MODEL)
